...
export function activate(context: ExtensionContext) {
  ...
  let disposableServiceCommand = commands.registerCommand(
  ...
  let disposableInterceptorCommand = commands.registerCommand(
  ...
  let disposablePipeCommand = commands.registerCommand(
  ...
  let disposableGuardCommand = commands.registerCommand(
  ...
  let disposableDecoratorCommand = commands.registerCommand(
  ...
  let disposableExceptionFilterCommand = commands.registerCommand(
  ...
  let disposableUnittestCommand = commands.registerCommand(
  ...
  let disposableGenerateGatewayCommand = commands.registerCommand(
  ...
  let disposableGenerateRedisAdapterCommand = commands.registerCommand(
  ...
  let disposableTransportCommand = commands.registerCommand(
  ...
  let disposableWebPackCommand = commands.registerCommand(
